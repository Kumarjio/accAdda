			...
			<div class="box box-primary">
				<div class="box-body">
					<div class="box-header with-border">
						<a href="add_purchase_invoice.php"><h3 class="box-title">Add Purchase Invoice</h3></a>
					</div>
						<div class="col-md-6">
							<div class="form-group">
								<label for="">Account Name </label>
								<input type="text" class="form-control" id="wid_magage_product_id" placeholder="Account Name" autocomplete="off" spellcheck="false">
...
<script src="plugins/search/manage_purchase_invoice_auto.js" ></script>
