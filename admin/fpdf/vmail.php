...
$pdf->AddPage();
	...
	$pdf->SetX(7);
	$pdf->SetFont('Arial','',12);
	$pdf->MultiCell(196,6,'To : -  '.$data->toa,0,1,'L');
	$pdf->Ln(5);
	$pdf->SetX(7);
...
$subject = "Project Verification From ".$company->company_name; 
$message = "<p>Please See This Verification .</p>";

$separator = md5(time());

$eol = PHP_EOL;

$filename = "Verification - ".$pro->project_name.".pdf";
