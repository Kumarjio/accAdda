...
<?php $sel_pur_no = $conn->query("SELECT * FROM n_quat_mst ORDER BY s_id DESC LIMIT 1")->fetch_object(); ?>
	...
	<form action="Process/add_quatation_process.php" id="form_full" method="post">
		...
		<div class="box box-primary">
			<div class="box-body">
				<div class="box-header with-border">
					...
					<div class="col-md-6">
						<div class="form-group">
						  <label for="">Quatation NO.</label>
						  <input type="text" class="form-control" value="QU_<?php if(empty($sel_pur_no->s_id)){echo 1;} else {echo $sel_pur_no->s_id+1;} ?>" id="" name="qa_no" placeholder="Quatation No." readonly>
				...
				<table id="table" class="table table-bordered table-hover">
						...
						<tbody class="input_fields_wrap_sales">
							<tr id="1">
								...
								<td><input type="number" style="width:80px;" min="0" name="quntity[]" class="1" id="sales_total1_quentity" required/></td>
								<td><input type="number" style="width:80px;" min="0" name="price[]" value="" id="sales_total1" required/></td>
					...
					<div class="col-md-6">
						<div class="form-group">
							<label for="">Freight</label>
								<input type="number" class="form-control"  min="0" id="" name="freight" placeholder="Enter Freight" value="0">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
...
<script src="plugins/dynamicadd/dynemic_qu_sl.js"></script>
