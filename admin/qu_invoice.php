...
<?php if(!isset($_GET['id'])){ header("location:ViewQuatation.php"); exit; } ?>
<?php include_once('header.php'); ?>
<?php include_once('sidebar.php'); ?>

<?php $query = $conn->query("SELECT * FROM n_quat_mst where s_id = '".$_GET['id']."'")->fetch_object(); ?>
...
<?php $query2 = $conn->query("SELECT * FROM n_quat_detail_mst where s_id = '".$query->s_id."'"); ?>
<?php $project = $con->query("select * from project_master where project_id = '".$query->prj_id."'")->fetch_object(); ?>


<section class="content-header">
    <h1>Chalan - <?php echo $query->s_numner; ?></h1>
</section>
<?php if(isset($_SESSION['emsg'])){ ?>
    ...
    <section class="content invoice">
     ...
     <?php $det_tax = $conn->query("SELECT * FROM n_quat_detail_mst where s_id = '".$query->s_id."'"); ?>
	  ...
	  <div class="row no-print">
        <div class="col-xs-12">
		<a href="fpdf/qmail.php?id=<?php echo $_GET['id']; ?>"> <button type="submit" class="btn btn-primary pull-right" style="margin-right: 5px;">            <i class="fa fa-download"></i> Send Mail          </button></a>
			 <a href="fpdf/quatation.php?id=<?php echo $_GET['id']; ?>"> <button type="submit" class="btn btn-primary pull-right" style="margin-right: 5px;">
