						...
						<h3 class="box-title">Search Invoice</h3>
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="acc_name_view_quatation" placeholder="Enter Account Name" autocomplete="off" spellcheck="false">
								...
								<div class="col-md-6">
									<div class="form-group">
										<label>Project Name</label>
											<select id="project_id" onchange="searchFilter()" class="form-control">
								...
								<div class="col-md-6">
									<div class="form-group">
									  <label for="">QO NO</label>
									  <input type="text" class="form-control" id="qutation_no" name="" placeholder="" autocomplete="off" spellcheck="false">
									</div>
								</div>
				</div>	
				<div class="box-body">
...
function searchFilter(page_num) {
    ...
    $.ajax({
        type: 'POST',
        url: 'manage_search/quatation_getData.php',
...
<script src="plugins/search/view_quatation_auto.js" ></script>
