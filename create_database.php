...
include_once('admin/function/add_database_func.php');  
if(isset($_POST['add_year']))
{
	...
	{
		$_SESSION['emsg'] = "OOps Database ".$_POST['financial_year']." Already Created";
		echo "<script>window.location='create_database.php';</script>";
		exit;
	}
	else
	{
