...
$subject = "Sales Invoice From ".$company->company_name; 
$message = "<p>Please See This Invoice.</p>";

$separator = md5(time());

$eol = PHP_EOL;

$filename = "Sales Invoice - ".$data->s_numner.".pdf";
...
if($aaaa) 
{
	...
	header('location:../sales_invoice.php?sales_invoice_id='.$_GET['id']);
	exit;
}
else
{
