...
$chalan = $conn->query("SELECT * FROM quatation_mst where s_id = '".$_GET['id']."'")->fetch_object();
$client = $con->query("Select * from client_master where client_id = '".$chalan->act_no."'")->fetch_object();
?>
<form action="Process/edit_challan_process.php" id="form_full" method="post"> 
		...
		<div class="col-md-12">
			...
			<div class="box-header with-border">
				...
				<table id="table" class="table table-bordered table-hover">
						...
						<?php $p_de = $conn->query("select * from quatation_detail_mst where s_id = '".$_GET['id']."'"); $c = 0; $su_total = 0; $cgst_s = 0; $sgst_s = 0; $igst_s = 0;
						...
						?>
							<tr id="<?php echo $c; ?>">
								...
								<td><input type="number" style="width:80px;" name="quntity[]" value="<?php echo $p_der->qty; ?>" min="0" class="<?php echo $c; ?>" id="sales_total<?php echo $c; ?>_quentity" required/></td>
								<td><input type="number" style="width:80px;" name="price[]" value="<?php echo $p_der->rate; ?>" min="0" id="sales_total<?php echo $c; ?>" required/></td>
							...
							<script>
								$(function(){
									...
									$('#remove<?php echo $c ?>').click(function(){
										...
										$.ajax({
											method : "POST",
											url : "Process/delete_chalan_row.php",
					...
					<div class="col-md-6">
						<div class="form-group">
							<label for="">Freight</label>
								<input type="number" class="form-control" min="0" value="<?php echo $chalan->freight; ?>" id="" name="freight" placeholder="Enter Freight" value="0">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
...
<script src="plugins/dynamicadd/dynemic_chalan_sledit.js"></script>
