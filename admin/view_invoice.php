		...
		<div class="col-md-12">
			<div class="box box-primary">
				<div class="box-header with-border col-md-12">
				  <a href="add_expencess.php"><h3 class="box-title">Add Expenses</h3></a>
				</div>
				<div class="box-body " >
					<div class="col-md-6">
						<div class="form-group">
							  <label for="exampleInputEmail1">Account Name</label>
							  <input type="text" class="form-control" id="view_invoice_name" placeholder="Enter Account Name" name="account_name">
							  <input type="hidden" id="view_invoice_hidden">
						</div>
					</div> 
					<div class="col-md-6">
							<div class="form-group">
...
function searchFilter(page_num) {
    ...
    var keywords = $('#view_invoice_hidden').val();
    ...
    $.ajax({
        type: 'POST',
        url: 'manage_search/Expenses_getData.php',
...
<script>
 ...
 <script src="plugins/search/view_invoice_auto.js"></script>
