...
<?php $sel_pur_no = $conn->query("SELECT * FROM purchase_mst ORDER BY s_id DESC LIMIT 1")->fetch_object(); ?>
	...
	<form action="Process/add_pu_in_process.php" id="form_full" method="post">
				...
				<div class="box-header with-border">
						...
						<div class="col-md-12">
							<div class="col-md-6">
								<div class="form-group">
								  ...
								  <textarea type="text" name="client_address" class="form-control" id="client_address_sales" placeholder="" readonly required></textarea>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
								  <label for="">Chalan No.</label>
								  <input type="text" class="form-control" id="" name="ch_no" placeholder="Enter Chalan No.">
								</div>
							</div>	
						</div>
					</div>
						...
						<div class="form-group">
							<label>Chalan Date</label>
								<div class="input-group">
									...
									<input type="text" placeholder="Select Chalan Date" name="ch_date" id="product_lr_date_sales" class="form-control">
								</div>
								<script> 
								$(function()
								{
					...
					<div class="col-md-6">
						<div class="form-group">
						  ...
						  <input type="text" class="form-control" value="PI_<?php if(empty($sel_pur_no->s_id)){echo 1;} else {echo $sel_pur_no->s_id+1;} ?>_<?php echo $_SESSION['year']; ?>" id="" name="qa_no" placeholder="Purchase No." readonly>
				...
				<table id="table" class="table table-bordered table-hover">
						...
						<tbody class="input_fields_wrap_sales">
							<tr id="1">
								...
								<td><input type="hidden" name="id[]" id="id" /><input type="hidden" id="sales_detail1_grate"/><input type="text" class="1d" id="sales_detail" name="product_name[]" style="width:120px;" required /></td>
								...
								<td><input type="number" min="0" style="width:80px;" name="quntity[]" class="1" id="sales_total1_quentity" required/></td>
								<td><input type="number" min="0" style="width:80px;" name="price[]" value="" id="sales_total1" required/></td>
...
<script src="plugins/search/autocomplete_pur_sl.js"></script>
<script src="plugins/dynamicadd/dynemic_pur_sl.js"></script>
