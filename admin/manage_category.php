   ...
   <div class="row">
        <div class="col-md-6">
		  ...
		  <div class="box-header with-border">
            ...
            <form action="Process/add_catagory_process.php" method="post" enctype="multipart/form-data" >
              <div class="box-body">
                <div class="form-group">
                  <input type="text" class="form-control" id="" name="catagory_name" placeholder="Enter category name" required>
                </div>
...
<?php
	...
	*/
	...
	$targetpage = "manage_category.php"; 	//your file name  (the name of this file)
...
<!-- pagination  --> 						
						<tbody>
							<?php $sr_n = 0; while($res_no = mysqli_fetch_object($result)){ $sr_n++;?>
									<tr>
									<td><a href="edit_catagory.php?edit_cat_id=<?php echo $res_no->catagory_id; ?>"><button type="button" class="btn btn-info btn-sm">Edit</button></a> &nbsp;<a href="Process/delete.php?del_cat_id=<?php echo $res_no->catagory_id; ?>" onclick="return confirm('Are you sure you want to delete this Category ?');"><button type="button" class="btn btn-danger btn-sm">Delete</button></a> </td>
										<td> <?php echo $sr_n; ?></td>
										<td><?php echo $res_no->name; ?></td>
