...
<?php include_once('sidebar.php'); error_reporting(0);?>
    ...
    <section class="content-header">
      <h1>
        Manage Purchase Return Invoice 
       </h1>
			...
			<div class="box box-primary">
				<div class="box-body">
					<div class="box-header with-border">
						<a href="purchase_return_invoice.php"><h3 class="box-title">Add Purchase Return Invoice</h3></a>
					</div>
					<div class="col-md-6">
						<div class="form-group">
						  <label for="">Account Name </label>
						 <input type="text" class="form-control" id="wid_magage_product_id" name="product_name_1" placeholder="Account Name" autocomplete="off" spellcheck="false">
					...
					<div class="col-md-6">
						<div class="form-group">
						  ...
						  <input type="text" class="form-control" id="acc_name_payment" name="" placeholder="P I No.">
						</div>
					</div>
				</div>
				<div class="box-body">
...
function searchFilter(page_num) {
	...
	var pi_no = $('#acc_name_payment').val();
    ...
    $.ajax({
        type: 'POST',
        url: 'manage_search/pu_return_getData.php',
...
<script src="plugins/search/view_return_invoice_auto.js"></script>
