		...
		<div class="box box-primary">
			<div class="box-body">
				<div class="box-header with-border">
					<a href="AddNewReciept.php"><h3 class="box-title">Add Receipt</h3></a>
				</div>
                
							<div class="col-md-6">
								<div class="form-group">
									<label for="">Account Name </label>
									<input type="text" class="form-control" id="acc_name_manage_reciept" placeholder="Enter Account Name" autocomplete="off" spellcheck="false">
									<input type="hidden" id="manage_reciept_client_id" />
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
...
function searchFilter(page_num) {
    ...
    var keywords = $('#manage_reciept_client_id').val();
    ...
    $.ajax({
        type: 'POST',
        url: 'manage_search/recept_getData.php',
...
<script src="plugins/search/manage_reciept_auto.js" ></script>
