...
<?php $query = $conn->query("SELECT * FROM purchase_return_mst where id = '".$_GET['id']."'")->fetch_object(); ?>
...
<?php $query2 = $conn->query("SELECT * FROM purchase_return_detail_mst where s_id = '".$query->id."'"); ?>
...
<section class="content-header">
    ...
    <section class="content invoice">
     ...
     <?php $det_tax = $conn->query("SELECT * FROM purchase_return_detail_mst where s_id = '".$query->id."'"); ?>
	  ...
	  <div class="row no-print">
        <div class="col-xs-12">
			 ...
			 <a href="fpdf/preturn.php?id=<?php echo $_GET['id']; ?>"> <button type="submit" class="btn btn-primary pull-right" style="margin-right: 5px;">
