...
<?php if(!isset($_GET['id'])){ header("location:ViewChallan.php"); exit; } ?>
<?php include_once('header.php'); ?>
<?php include_once('sidebar.php'); ?>

<?php $query = $conn->query("SELECT * FROM quatation_mst where s_id = '".$_GET['id']."'")->fetch_object(); ?>
...
<?php $query2 = $conn->query("SELECT * FROM quatation_detail_mst where s_id = '".$query->s_id."'"); ?>
...
<section class="content-header">
    ...
    <section class="content invoice">
     ...
     <?php $det_tax = $conn->query("SELECT * FROM quatation_detail_mst where s_id = '".$query->s_id."'"); ?>
	  ...
	  <div class="row no-print">
        <div class="col-xs-12">
			 ...
			 <a href="fpdf/chalan.php?id=<?php echo $_GET['id']; ?>"> <button type="submit" class="btn btn-primary pull-right" style="margin-right: 5px;">
